...
b.images=i.data;if(i.data.length){b.makeActiveSlide(b.imgCurrent);}if(c){d.cancel(c);}if(i.data.length){c=d(b.fetchImages,b.speed*i.data.length);}}).error(function(){delete b.loadingClass;
c=d(b.fetchImages,2000);});};d(b.fetchImages);b.advanceSlide=function(){if(angular.isDefined(b.images)&&b.images.length){b.makeActiveSlide(b.imgCurrent+1);
